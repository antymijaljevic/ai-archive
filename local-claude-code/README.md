...
4. **Pulls Your Model** - Downloads your chosen model (defaults to `qwen3-coder:latest`)
...
The script defaults to **`qwen3-coder:latest`** which pulls the **30B model**:
...
| [`qwen3-coder:latest`](https://ollama.com/library/qwen3-coder) | 30B (3.3B active) | 19GB | 16-24GB | RTX 3090/4090 | 256K |
...
| `qwen3-coder:latest` (30B) | 19GB | ✅ Recommended | Agentic coding, good context |
...
- **qwen3-coder:latest** (Default): Best balance for consumer hardware. Strong coding with 256K context.
